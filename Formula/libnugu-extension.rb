...
class LibnuguExtension < Formula
  ...
  url "https://github.com/webispy/#nugu-extension/archive/refs/tags/v1.7.4.tar.gz", using: GitHubPrivateRepositorySnapshotDownloadStrategy
  sha256 "7853a417e00038f3e2d42bacf7a1e09b528cb18f03e294cf444107ef12ece7e8"
  license "Apache-2.0"

  bottle do
    root_url "https://github.com/webispy/homebrew-sdk/releases/download/libnugu-extension-1.7.4"
    rebuild 2
